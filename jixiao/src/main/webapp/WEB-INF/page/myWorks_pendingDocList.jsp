		...
		<table width="98%" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td height="41" background="images/table/right-top-bg.jpg">
					...
					<span class="txt-blue">我的工作&gt;&gt;待办</span>
				</td>
			</tr>
		</table>
		<table width="98%" align="center" cellpadding="0" cellspacing="0">
								...
								<table width="100%" border="1" align="center" cellpadding="2"
									...
									<tr bgcolor="#FBE9B7">
										...
										<td width="53%" class="table-right-bottom-gray">
											<div align="center">
												<span class="txt-blue">待办考核标题</span>
											</div>
										</td>
										...
										<td width="19%" class="table-bottom-gray">
											<div align="center">
												<span class="txt-blue">考核时间</span>
											</div>
										</td>
									</tr>

									<c:forEach var="doc" items="${pageInfo.dataList}"
										varStatus="state">
										...
										<tr bgcolor='${state.count%2==0?"#E5EEFF":"#FFFFFF"}'>
											...
											<td class="table-right-bottom-gray">
												<a href="pendingCheck.do?flag=list&docId=${doc.docid }" target="_top" class="txt-gray">${doc.docname}</a>
											</td>
											<td class="table-right-bottom-gray">
												<a href="#" class="txt-gray">${doc.realname}</a>
											</td>
											<td class="table-bottom-gray">
												<span class="txt-gray">[<fmt:formatDate
														value="${doc.checktime }" pattern="yyyy-MM-dd"></fmt:formatDate>]</span>
											</td>
										</tr>
